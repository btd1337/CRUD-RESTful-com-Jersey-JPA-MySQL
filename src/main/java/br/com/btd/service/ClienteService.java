...
import br.com.btd.entitymanager.JpaEntityManager;
import br.com.btd.model.ClienteModel;
...
public class ClienteService {
	...
	public Response excluir(@PathParam("id_cliente") int id_cliente){
		try{
			ClienteModel objCliente = objEM.find(ClienteModel.class, id_cliente);
